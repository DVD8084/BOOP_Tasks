...
QT_MOC_LITERAL(1, 8, 19), // "on_name_textChanged"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 28), // "on_resultAmount_valueChanged"
QT_MOC_LITERAL(4, 58, 22) // "on_results_cellChanged"

    },
    "addForm\0on_name_textChanged\0\0"
    "on_resultAmount_valueChanged\0"
    "on_results_cellChanged"
};
...
void addForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_name_textChanged((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->on_resultAmount_valueChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->on_results_cellChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}
...
QT_INIT_METAOBJECT const QMetaObject addForm::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_addForm.data,
